...
a persistence unit "repasoJavaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "repasoJava/pom.xml":
...
artifact ("repasoJava.war") is already built. You can build
